...
import {Day, days, meals, recipes, Slot, slotRequirements, nutritionRequirements} from "./data";
...
type AuxDef = MealSlotAuxDef | NutritionAuxDef;
...
loadProblem(lp, structDefs, [...mealSlotAuxDefs, ...nutritionAuxDefs], constraints);
